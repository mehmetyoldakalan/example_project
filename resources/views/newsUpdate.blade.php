            ...
            <div class="block-content">
              <div class="row justify-content-center">
                <div class="col-md-10 col-lg-8">
                  <form action="{{route('newsUpdate',['id'=>$newsData[0]['news_id']])}}" method="POST" >
                    {{ csrf_field() }}
                    <div class="mb-4">
                    ...
                    <div class="row mb-4">
                        <div class="col-md-6">
                          ...
                          <input type="text" class="form-control" value="{{$newsData[0]['news_title']}}"  name="news_title" >
                        </div>
                      </div>
                      <div class="row mb-4">
                        <div class="col-md-12">
                          <label class="form-label" for="one-ecom-product-price">Ön Yazı</label>
                          <input type="text" class="form-control" value="{{$newsData[0]['news_coverletter']}}" name="news_coverletter" >
                        </div>
                      </div>

                    <div class="mb-4">
                      <label class="form-label" for="one-ecom-product-description-short">Haber İçeriği</label>
                      <textarea class="form-control" name="news_content" rows="4">{{$newsData[0]['news_content']}}</textarea>
                    </div>
